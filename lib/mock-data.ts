...
export const joiners: Joiner[] = [
  ...
  { id: '3', name: 'Arjun Kapoor', initials: 'AK', designation: 'Sales Executive',       dept: 'Sales',         doj: '2026-06-23', joinedDate: '23 Jun', videosWatched: 2, totalVideos: 4, progress: 72,  status: 'in-progress',   inviteStatus: 'accepted',    emailStatus: 'delivered', email: 'arjun.k@koenig.com',  avatarColor: '#4A9BE8' },
