...
export const joiners: Joiner[] = [
  { id: '1', name: 'Rahul Mehta',  initials: 'RM', dept: 'IT Department', joinedDate: '16 Jun', videosWatched: 4, totalVideos: 4, progress: 100, status: 'complete',     inviteStatus: 'accepted',    emailStatus: 'delivered', email: 'rahul.m@koenig.com',  avatarColor: '#27B882' },
  { id: '2', name: 'Priya Singh',  initials: 'PS', dept: 'HR Department', joinedDate: '16 Jun', videosWatched: 3, totalVideos: 4, progress: 85,  status: 'in-progress',   inviteStatus: 'accepted',    emailStatus: 'delivered', email: 'priya.s@koenig.com',  avatarColor: '#4A9BE8' },
  { id: '3', name: 'Arjun Kapoor', initials: 'AK', dept: 'Sales',         joinedDate: '23 Jun', videosWatched: 2, totalVideos: 4, progress: 72,  status: 'in-progress',   inviteStatus: 'accepted',    emailStatus: 'delivered', email: 'arjun.k@koenig.com',  avatarColor: '#4A9BE8' },
  { id: '4', name: 'Sneha Patel',  initials: 'SP', dept: 'Finance',       joinedDate: '23 Jun', videosWatched: 2, totalVideos: 4, progress: 60,  status: 'in-progress',   inviteStatus: 'accepted',    emailStatus: 'delivered', email: 'sneha.p@koenig.com',  avatarColor: '#27B882' },
  { id: '5', name: 'Dev Sharma',   initials: 'DS', dept: 'IT Department', joinedDate: '23 Jun', videosWatched: 1, totalVideos: 4, progress: 45,  status: 'needs-nudge',   inviteStatus: 'pending',     emailStatus: 'delivered', email: 'dev.s@koenig.com',    avatarColor: '#F4A622' },
  { id: '6', name: 'Kavya Nair',   initials: 'KN', dept: 'Marketing',     joinedDate: '23 Jun', videosWatched: 1, totalVideos: 4, progress: 30,  status: 'behind',        inviteStatus: 'accepted',    emailStatus: 'delivered', email: 'kavya.n@koenig.com',  avatarColor: '#E85A4A' },
  { id: '7', name: 'Rohan Gupta',  initials: 'RG', dept: 'Sales',         joinedDate: '24 Jun', videosWatched: 0, totalVideos: 4, progress: 20,  status: 'not-started',   inviteStatus: 'no-response', emailStatus: 'bounced',   email: 'rohan.g@koenig.com',  avatarColor: '#1B2D50' },
  { id: '8', name: 'Ananya Raj',   initials: 'AR', dept: 'HR Department', joinedDate: '24 Jun', videosWatched: 0, totalVideos: 4, progress: 8,   status: 'not-started',   inviteStatus: 'no-response', emailStatus: 'delivered', email: 'ananya.r@koenig.com', avatarColor: '#E85A4A' },
]
